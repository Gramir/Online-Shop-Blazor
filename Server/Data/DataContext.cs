    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating (ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Category>().HasData(
               ...
               new Category { Id = 3, Name = "Electronics", Url = "electronics", Icon = "monitor" }
            );
            ...
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product
                {
                 ...
                 new Product
                 {
                     ...
                     CategoryId = 2,
                     Title = "Game #1",
                     Description = "Game number one",
                     Image = "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fe/Video-Game-Controller-Icon-IDV-green.svg/2048px-Video-Game-Controller-Icon-IDV-green.svg.png",
                     Price = 9.90m,
                     OriginalPrice = 9.90m,
                     DateCreated = new DateTime(2021, 10, 1)
                 },
                 new Product
                 {
                     ...
                     CategoryId = 3,
                     Title = "Console #1",
                     Description = "Console number one",
                     Image = "https://m.media-amazon.com/images/I/619Bmcg-EIL.jpg",
                     Price = 1000.90m,
                     OriginalPrice = 1110.90m,
                     DateCreated = new DateTime(2021, 10, 1)
                 }
                );
